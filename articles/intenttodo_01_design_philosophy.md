...
3. **プラットフォーム固有の実装へ展開**: ウィジェット / Live Activity / Control Center / メインアプリへ
...
|---|---|---|
| 毎日確認する情報 | ウィジェット | 今日の Todo 一覧 |
| 頻繁に変わる情報 | watchOS コンプリケーション | 次の期限 |
| 繰り返しのアクション | Shortcuts / Siri | Todo 追加 |
| 常時追跡が必要な情報 | ライブアクティビティ | 期限 1 時間以内の Todo |
